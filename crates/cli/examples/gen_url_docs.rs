...
//! endpoint config structs used by `mq-bridge-app copy --from/--to` (see
...
struct Connector {
    ...
    title: &'static str,
    /// URI schemes `mq-bridge-app copy` recognises for this connector.
...
fn main() -> std::io::Result<()> {
    ...
    let mut index = String::from(
        "<!-- GENERATED by `cargo run -p mq-bridge-app --example gen_url_docs`. Do not edit by hand. -->\n\n\
         ...
         Auto-generated from the same JSON Schemas `mq-bridge-app copy` uses to parse \
