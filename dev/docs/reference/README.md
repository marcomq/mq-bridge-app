...
Auto-generated from the same JSON Schemas `mq-bridge copy` uses to parse `--from`/`--to` query parameters (see `crates/cli/src/main.rs::endpoint_from_uri`). For workflow examples, see the [connector pages](../connectors/).
